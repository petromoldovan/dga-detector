# source: https://github.com/baderj/domain_generation_algorithms/blob/master/kraken/v2/dga_v2.py
import random
import time
...
def generate_domains(num_domains, date, seed='a', tld_set=3):
    domains = []
    for i in range(num_domains):
        domains.append(generate_domain(i*2, date, seed, True, tld_set))
