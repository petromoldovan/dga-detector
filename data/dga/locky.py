# source: https://github.com/baderj/domain_generation_algorithms/blob/master/locky/dgav2.py
...
def generate_domains(nr, d=None, config_nr=1):
    ret = []

    d = d if d else datetime.now()

    for i in range(nr):
        ret.append(dga(d, config_nr, i))
