# Source: https://github.com/baderj/domain_generation_algorithms/blob/master/corebot/dga.py
...
def generate_domains(number_of_items, seed='2321DBA33', d=None, nr_b=1):
    current_date = d
    if not current_date:
        current_date = datetime.now()

    charset, r = init_rand_and_chars(
        current_date.year,
        current_date.month,
        current_date.day,
        nr_b,
